...
<form method="POST">
	<table  border="1" class="table">
        ...
        $busca=$mysqli -> query ("SELECT * FROM usuarios WHERE id_usuario='$id_usuario'");
...
?>
                         ...
                         <button type="button" class="btn btn-success"><a href="modificar.php" style="color:white;"> CONSULTA</a></button> <br><br>
