...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMP1AwP/5lN5Sn9/j5zW4rZpEifv7oH/kxL6D/W" crossorigin="anonymous">
</head>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="icon-center">
                            <a href="tabla.php?id_usuario=<?php echo $datos['id_usuario']; ?>">
                        ...
                        <?php if ($rol == 'administrador') { ?>
                            <td class="icon-center">
                                <a href="elimin.php?id_usuario=<?php echo $datos['id_usuario']; ?>">
